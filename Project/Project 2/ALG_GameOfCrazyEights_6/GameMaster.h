...
class GameMaster {
    private:
        ...
        static array<int,512> pNames;//Hash table/Bit vector of player names
        
        void enterInfo(int);                    //Enter player info
        void shuffleCards();                    //Shuffle Cards
        void createHand(int, int, int);         //Create hand
        void dealCards(int, int, int);          //Deal 5 Cards to All Players
        ...
        int partition(vector<Card> &, int, int);//Helper function for QuickSort
        void quickSort(vector<Card> &, int, int);//QuickSort for unused cards
