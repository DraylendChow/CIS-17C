    ...
    while(!gameOver) {
        ...
        for(int i = 0; i < playerSize; i++) {
            ...
            while(!playerDone) {
                ...
                sort(players[i]->getHand(), players[i]->getHand() + players[i]->getCardAmount(), handCmp);
                ...
                for_each(players[i]->getHand(), players[i]->getHand() + players[i]->getCardAmount(), printHand);
                cout << "\b\b]" << endl;
